                ...
                <div className="relative z-10 flex flex-col items-center max-w-md text-center">
                    ...
                    <div className="panel p-8 mb-8 w-full backdrop-blur-md">
                        ...
                        <div className="flex justify-center">
                            <div className="py-3 px-6 bg-slate-900/80 border border-cyan-700/40 rounded-md text-cyan-300 shadow-[0_0_10px_rgba(8,145,178,0.15)] backdrop-blur-md flex items-center gap-3">
